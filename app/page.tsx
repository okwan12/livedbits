...
export default async function HomePage() {
  const [places, songs] = await Promise.all([getPlaces(), getSongs()]);
  ...
  return (
    <div>
      <section className="px-8 pt-8 md:pt-12 pb-24">
        <div className="grid gap-6 md:grid-cols-3">
              <div className="md:col-span-2">
                <h2 className="font-body text-sm uppercase tracking-widest2 label-on-dots mb-8">
                  Stops
                </h2>
                <CheckInMap
                  places={places}
              ...
              <div className="md:col-span-1">
                ...
                {/* TODO: replace the placeholder numbers and lines below with your
                    ...
                    apply to you. */}
                <div className="glass-panel p-6 md:h-[440px] overflow-y-auto font-body text-center">
      ...
      <section className="px-8 pb-28">
        ...
        <div className="quote-on-dots space-y-6 font-body text-lg leading-relaxed">
          <p>
